...
void TextureManager::draw(SDL_Rect src, SDL_Rect dest, int alpha, SDL_RendererFlip flip) {
    SDL_SetTextureBlendMode(TextureManager::tex, SDL_BLENDMODE_BLEND);
    SDL_SetTextureAlphaMod(TextureManager::tex, alpha);
