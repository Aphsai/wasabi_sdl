...
void Sushi::addAnimations() {
	...
	gc->addAnimation(WALK, SDL_Rect { 20 * TILESHEET_SIZE, 0 * TILESHEET_SIZE, TILESHEET_SIZE, TILESHEET_SIZE }, 3, 5);
...
void Sushi::init() {
	...
	addComponent<GraphicsComponent>(GRAPHICS_COMPONENT, SDL_Rect { 20 * TILESHEET_SIZE, 0 * TILESHEET_SIZE, TILESHEET_SIZE, TILESHEET_SIZE });
