...
enum { INPUT_COMPONENT, GRAPHICS_COMPONENT, PHYSICS_COMPONENT, COLLIDER_COMPONENT, JUMPING_COMPONENT, LIGHT_COMPONENT, CAMERA_COMPONENT, HEALTH_COMPONENT, FLYING_COMPONENT };
